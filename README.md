...
2. Use [this template](https://github.com/CommonGateway/ZGWBundle/generate)
...
5. Update file names and namespace to your fitting 
   ...
   - Open PetStoreBundle.php and change the Bundle name and namespace. The namespace should be the same as your package name in composer.json but in CamelCase. So common-gateway/pet-store-bundle becomes CommonGateway/ZGWBundle
